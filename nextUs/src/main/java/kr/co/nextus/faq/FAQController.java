...
public class FAQController {
	...
	public String aindex(Model model, FAQVO vo, SellerRequestVO vo2, BuyListVO vo3, HttpServletRequest request) {
	...
	public String awrite(Model model, SellerRequestVO vo2, BuyListVO vo3, HttpServletRequest request) {
		Boolean adminLoggedIn = (Boolean) request.getSession().getAttribute("adminLoggedIn");
		if (adminLoggedIn != null && adminLoggedIn) {
			model.addAttribute("SRnew", SRservice.NEW(vo2));
			model.addAttribute("STnew", BLservice.settleNEW(vo3));
	...
	public String ainsert(Model model, FAQVO vo, SellerRequestVO vo2, BuyListVO vo3, HttpServletRequest request) {
		Boolean adminLoggedIn = (Boolean) request.getSession().getAttribute("adminLoggedIn");
		if (adminLoggedIn != null && adminLoggedIn) {
			int r = service.insert(vo);
	...
	public String aview(Model model, FAQVO vo, SellerRequestVO vo2, BuyListVO vo3, HttpServletRequest request) {
		Boolean adminLoggedIn = (Boolean) request.getSession().getAttribute("adminLoggedIn");
		if (adminLoggedIn != null && adminLoggedIn) {
			model.addAttribute("vo", service.detail(vo, true));
	...
	public String aedit(Model model, FAQVO vo, SellerRequestVO vo2, BuyListVO vo3, HttpServletRequest request) {
		Boolean adminLoggedIn = (Boolean) request.getSession().getAttribute("adminLoggedIn");
		if (adminLoggedIn != null && adminLoggedIn) {
			model.addAttribute("vo", service.detail(vo, false));
	...
	public String aupdate(Model model, FAQVO vo, SellerRequestVO vo2, BuyListVO vo3, HttpServletRequest request) {
		Boolean adminLoggedIn = (Boolean) request.getSession().getAttribute("adminLoggedIn");
		if (adminLoggedIn != null && adminLoggedIn) {
			int r = service.update(vo);
			model.addAttribute("SRnew", SRservice.NEW(vo2));
	...
	public String adelete(Model model, FAQVO vo, SellerRequestVO vo2, BuyListVO vo3, HttpServletRequest request) {
		Boolean adminLoggedIn = (Boolean) request.getSession().getAttribute("adminLoggedIn");
		if (adminLoggedIn != null && adminLoggedIn) {
