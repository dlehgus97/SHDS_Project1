...
public class EventController {
	...
	public String adindex(Model model, EventVO vo, SellerRequestVO vo2, BuyListVO vo3, HttpServletRequest request) {
	...
	public String adwrite(Model model, SellerRequestVO vo2, BuyListVO vo3, HttpServletRequest request) {
		Boolean adminLoggedIn = (Boolean) request.getSession().getAttribute("adminLoggedIn");
		if (adminLoggedIn != null && adminLoggedIn) {
			model.addAttribute("SRnew", SRservice.NEW(vo2));
			model.addAttribute("STnew", BLservice.settleNEW(vo3));
	...
	public String adinsert(Model model, HttpServletRequest request, EventVO vo, MultipartFile file, SellerRequestVO vo2,
			BuyListVO vo3) {
		Boolean adminLoggedIn = (Boolean) request.getSession().getAttribute("adminLoggedIn");
		if (adminLoggedIn != null && adminLoggedIn) {
			HttpSession sess = request.getSession();
	...
	public String adview(Model model, EventVO vo, SellerRequestVO vo2, BuyListVO vo3, HttpServletRequest request) {
		Boolean adminLoggedIn = (Boolean) request.getSession().getAttribute("adminLoggedIn");
		if (adminLoggedIn != null && adminLoggedIn) {
			model.addAttribute("vo", service.detail(vo, true));
			model.addAttribute("SRnew", SRservice.NEW(vo2));
	...
	public String adedit(Model model, EventVO vo, SellerRequestVO vo2, BuyListVO vo3, HttpServletRequest request) {
		Boolean adminLoggedIn = (Boolean) request.getSession().getAttribute("adminLoggedIn");
		if (adminLoggedIn != null && adminLoggedIn) {
			model.addAttribute("vo", service.detail(vo, false));
			model.addAttribute("SRnew", SRservice.NEW(vo2));
	...
	public String adupdate(Model model, HttpServletRequest request, EventVO vo, MultipartFile file, SellerRequestVO vo2,
			BuyListVO vo3) {
		Boolean adminLoggedIn = (Boolean) request.getSession().getAttribute("adminLoggedIn");
		if (adminLoggedIn != null && adminLoggedIn) {
			int r = service.update(vo, file, request);
	...
	public String addelete(Model model, HttpServletRequest request, EventVO vo, MultipartFile file, SellerRequestVO vo2,
			BuyListVO vo3) {
		Boolean adminLoggedIn = (Boolean) request.getSession().getAttribute("adminLoggedIn");
		if (adminLoggedIn != null && adminLoggedIn) {
			int r = service.delete(vo, request);
