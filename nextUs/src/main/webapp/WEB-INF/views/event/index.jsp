    ...
    <div class="wrap">
        ...
        <div class="sub">
            <div class="size">
                ...
                <div class="bbs">
                    <table class="list">
                    <p><span><strong>총 ${map.count }개</strong>  |  ${eventVO.page }/${map.totalPage }페이지</span></p>
                        ...
                        <c:forEach var="vo" items="${map.list }">       
                            <tr>
                                ...
                                <td class="startdate"><fmt:formatDate value="${vo.start }" pattern="YYYY-MM-dd"/></td>
                                <td class="enddate"><fmt:formatDate value="${vo.end }" pattern="YYYY-MM-dd"/></td>
                            </tr>
                       </c:forEach>
                        </tbody>
                    </table>
